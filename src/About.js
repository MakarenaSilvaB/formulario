...
export const About = () => (
  <div className="App">
    <div className="new-line"><img src={about} alt="pic" className="line-jump"/></div>
    ...
    <div className="container">
      ...
      <div className="centering">
        <p> Comparto lo enlaces de las cuentas y herramientas involucradas en este recorrido: </p>
          <a href="https://hub.docker.com/repository/docker/makarenasilva/mi-validador" className="App-link"> Docker Hub </a>| 
